...
static ssize_t gt1x_tool_read(struct file *filp,
	char __user *buffer, size_t count, loff_t *ppos);
static ssize_t gt1x_tool_write(struct file *filp,
...
static const struct proc_dir_entry *gt1x_tool_proc_entry;
...
int gt1x_init_tool_node(void)
{
	...
	gt1x_tool_proc_entry = proc_create(procname,
		0644, NULL, &gt1x_tool_fops);
	...
	const char __user *buff, size_t len, loff_t *data)
{
	...
	if (1 == cmd_head.wr) {
		...
		thrd = kthread_run(gt1x_update_firmware,
