...
#include <linux/input/synaptics_dsx_v20.h>
...
extern int factory_get_ic_fw_version(struct device *dev, char *buf);
...
extern int factory_get_rawdata_info(struct device *dev, char *buf);
extern int factory_get_rawdata(struct device *dev, char *buf);
extern int factory_get_calibration_ret(struct device *dev);
extern int factory_proc_hibernate_test(struct device *dev);
extern int factory_proc_fw_bin_update(struct device *dev, const char *buf);
extern int factory_short_test(struct device *dev, char *buf);
